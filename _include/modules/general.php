...
// LANDING PAGES THAT ARE PROMOTING LICENSES FOR CERTAIN SERVICES
	...
	// Parallels Landing Pages
		...
		// Keywords: Magiscpam
			$seo_magicspam_server_main = "MagicSpam";
			$seo_magicspam_server_title = "MagicSpam";
			$seo_magicspam_server_keywords = "MagiscSpam";
			$seo_magicspam_server_description = "MagicSpam";
...
// THE SITE. PLEASE ADD / REMOVE / EDIT BASED UPON THE LICENSES THAT ARE BEING ORDERED
	...
	// ADDITIONAL LICENSES SECTION
		...
		$additional_magicspam_title = _("MagicSpam");
		$additional_magicspam_meta_description = _("Magic Spam is installed with cpanel, plesk or on a standalone mail server to actually be part of the email server, so spam is identified at the edge, during the SMTP handshake phase. Blocking these bad sources of email, immediately creates a huge savings in bandwidth, cpu resources, and ram.  You also reduce backscatter problems created when checking for spam after the message has been accepted");
		$additional_magicspam_keywords = _("");
