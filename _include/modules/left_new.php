				...
				<div class="lc-side-menu">
					...
					<ul>
						...
						<li class="header"><h2><?=_('Information')?></h2></li>

						<li><a href="<?=$site_dir?><?=_('/company/');?>"<?php if( $page=="about" ) { ?> class="selected"<?php } else { ?><?php } ?> title="<?=_('LicenseCube About Us')?>"><?=_('About Us')?></a></li>
						...
						<li><a href="<?=$site_dir?><?=_('/support/kb/');?>"<?php if( $page=="support" ) { ?> class="selected"<?php } else { ?><?php } ?> title="<?=_('LicenseCube Support Center')?>"><?=_('Support Center')?></a></li>
               ...
               <div class="ltMenu " style=" border:0px;">      
                  ...
                  <ul>
                    ...
                    <li><a href="http://www.licensecube.com/support/kb/" <?php if( $page=="support" ) { ?> class="selected"<?php } else { ?><?php } ?>>Overview</a></li>	                
               ...
               <?php } else { ?><?php } ?>
				...
				<div class="lc-side-menu">
					...
					<ul>
                       ...
                       <!-- <li class="cpanel cpanel-only-dedicated" <?php if (($page != 'cp5')) { ?> style="display: none;"<?php }?>><a href="<?=$site_dir?><?=_('/control-panels/enkompass-license.php?dedicated');?>"<?php if( $page=="cp5" ) { ?> class="selected"<?php } else { ?><?php } ?> title="<?=_('Enkompass License');?>">Enkompass</a></li>-->

                        <li class="cpanel" <?php if (($page != 'cp6') ) { ?> <?php }?>><a href="<?=$site_dir?><?=_('/control-panels/parallels-virtuozzo-license.php');?>"<?php if( $page=="cp6" ) { ?> class="selected"<?php } else { ?><?php } ?> title="<?=_('Virtuozzo License');?>">Virtuozzo  <?php print("$dedicated_virtuozzo"); ?> </a></li>

                         <li class="cpanel" <?php if (($page != 'cp10') ) { ?> <?php }?>><a href="<?=$site_dir?><?=_('/control-panels/solusvm-license.php');?>"<?php if( $page=="cp10" ) { ?> class="selected"<?php } else { ?><?php } ?> title="<?=_('SolusVM License');?>">SolusVM </a></li>
				...
				<div class="lc-side-menu">
					...
					<ul>
                        ...
                        <li><a href="<?=$site_dir?><?=_('/billing-systems/blesta-license.php');?>"<?php if( $page=="bill4" ) { ?> class="selected"<?php } else { ?><?php } ?> title="<?=_('Blesta License');?>">Blesta</a></li>
       					...
       					<li class="last"><a href="<?=$site_dir?><?=_('/billing-systems/clientexec-license.php');?>"<?php if( $page=="bill5" ) { ?> class="selected"<?php } else { ?><?php } ?> title="<?=_('ClientExec License');?>">ClientExec</a></li>
				...
				<div class="lc-side-menu">
					...
					<ul>
						...
						<li class="addit"><a href="<?=$site_dir?><?=_('/additional-licenses/parallels-sitebuilder-license.php');?>"<?php if( $page=="addi1" ) { ?> class="selected"<?php } else { ?><?php } ?> title="<?=_('Parallels SiteBuilder License');?>">Plesk SiteBuilder</a></li>
                        ...
                        <!--<li class="additional-only-dedicated addit" <?php if (($page != 'addi7') && !$dedicated) { ?> style="display: none;"<?php }?>><a href="<?=$site_dir?><?=_('/additional-licenses/ksplice-license.php?dedicated');?>"<?php if( $page=="addi7" ) { ?> class="selected"<?php } else { ?><?php } ?> title="<?=_('Ksplice Uptrack');?>">Ksplice</a></li>-->

                        

                         <li class="additional-only-dedicated addit" <?php if (($page != 'addi8') && !$dedicated) { ?> style="display: none;"<?php }?>><a href="<?=$site_dir?><?=_('/additional-licenses/cloudlinux-license.php?dedicated');?>"<?php if( $page=="addi8" ) { ?> class="selected"<?php } else { ?><?php } ?> title="CloudLinux">CloudLinux</a></li>
					...
					<ul>
                     ...
                     <div id="popup4" class="modal-box">
                        <div id="signup-header">
                            ...
                            <div class="close-modal"><a class="modal_close" href="#" onclick="return false;">×</a></div>
                        </div>
...
<?php if( $menu!="support") { ?>
                ...
                <?php if( ($left=="information" or $menu=="support") and ($page!='api' and $page!='contact') ) { ?>
