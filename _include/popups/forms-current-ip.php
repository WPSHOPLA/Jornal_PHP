...
<div class="lc-popup">
	...
	<div class="lc-box-header">
		<div class="lc-float-left"><h2><?=_('Current IP Address');?></h2></div>
	...
	<div class="lc-box" style="padding: 0px 18px 3px 18px;">
		...
		<div id="form" class="lc-form">
				...
				<p><?=_('his is the IP address that your license currently resides on. This information can be found in your welcome email, so you can enter this information in correctly.');?>T </p>
