...
<div class="lc-popup">
	...
	<div class="lc-box-header">
		<div class="lc-float-left"><h2><?=_('New Requested IP Address');?></h2></div>
	...
	<div class="lc-box" style="padding: 0px 18px 3px 18px;">
		...
		<div id="form" class="lc-form">
				...
				<p><?=_('In this section, please enter in the new IP Address of your license, which you would like. This is the IP address that is going to supersede the IP address that is listed in the "Current IP Address" field.');?>  </p>
