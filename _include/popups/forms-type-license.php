...
<div class="lc-popup">
	...
	<div class="lc-box-header">
		<div class="lc-float-left"><h2><?=_('Type Of License');?></h2></div>
	...
	<div class="lc-box" style="padding: 0px 18px 3px 18px;">
		...
		<div id="form" class="lc-form">
				...
				<p><?=_('This is where you need to specify, which license you are looking to modify. Please specify, the license type, so you may continue onto the next step.');?></p>
