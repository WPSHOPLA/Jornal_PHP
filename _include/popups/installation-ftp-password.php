...
<div class="lc-popup">
	...
	<div class="lc-box-header">
		<div class="lc-float-left"><h2><?=_('FTP Password');?></h2></div>
	...
	<div class="lc-box" style="padding: 0px 18px 3px 18px;">
		...
		<div id="form" class="lc-form">
				...
				<p><?=_('The FTP password is the password that you use to login to your control panel in most cases. We will need this password in order to be able to access your FTP and start installation the newly licensed software.');?></p>
