	...
	<div class="lc-content-wrapper-inner">
		...
		<tr>
			<td class="lc-content-left" valign="top">
				...
				<?php $left="cp"; $page=""; include_once("../_include/modules/left_new.php"); ?>
...
add_overlay_box(array('title' => 'cPanel/WHM', 'info-url' => _('/control-panels/cpanel-license.php'), 'code' => 'LIN0', 'period' => _('Monthly'), 'logo' => 'logo-cpanel.gif', 'infodivid' => 'info1', 'bg-position' => '14', 'bg-image' => 'logo-control-panel'));
add_overlay_box(array('title' => 'Plesk Panel', 'info-url' => _('/control-panels/plesk-license.php'), 'code' => 'LIN72', 'period' => _('Monthly'), 'logo' => 'logo-parallelspleskpanel.gif', 'infodivid' => 'info2', 'bg-position' => '-104', 'bg-image' => 'logo-control-panel'));
add_overlay_box(array('title' => 'Direct Admin', 'info-url' => _('/control-panels/directadmin-license.php'), 'code' => 'LIN5', 'period' => _('Monthly'), 'logo' => 'logo-directadmin.gif', 'infodivid' => 'info3', 'bg-position' => '-238', 'bg-image' => 'logo-control-panel'));
add_overlay_box(array('title' => 'Softaculous', 'info-url' => _('/control-panels/softaculous-license.php'), 'code' => 'LIN10', 'period' => _('Monthly'), 'logo' => 'logo-softaculous.gif', 'infodivid' => 'info4', 'bg-position' => '-369', 'bg-image' => 'logo-control-panel'));
add_overlay_box(array('title' => 'Fantastico', 'info-url' => _('/control-panels/fantastico-license.php'), 'code' => 'LIN9', 'period' => _('Monthly'), 'logo' => 'logo-fantastico.gif', 'infodivid' => 'info5', 'bg-position' => '-504', 'bg-image' => 'logo-control-panel'));
add_overlay_box(array('title' => 'Installatron', 'info-url' => _('/control-panels/installatron-license.php'), 'code' => 'LIN44', 'period' => _('Monthly'), 'logo' => 'logo-installatron.gif', 'infodivid' => 'info9', 'bg-position' => '-633', 'bg-image' => 'logo-control-panel'));
add_overlay_box(array('title' => 'InterWorx', 'info-url' => _('/control-panels/interworx-license.php'), 'code' => 'LIN48', 'period' => _('Monthly'), 'logo' => 'logo-interworx.gif', 'infodivid' => 'info11', 'bg-position' => '-763', 'bg-image' => 'logo-control-panel'));
add_overlay_box(array('title' => 'ISPmanager', 'info-url' => _('/control-panels/ispmanager-license.php'), 'code' => 'LIN51', 'period' => _('Monthly'), 'logo' => 'logo-ispmanager.gif', 'infodivid' => 'info12', 'bg-position' => '-895', 'bg-image' => 'logo-control-panel'));
add_overlay_box(array('title' => 'Virtuozzo', 'info-url' => _('/control-panels/parallels-virtuozzo-license.php'), 'code' => 'LIN74', 'period' => _('Monthly'), 'logo' => 'logo-parallelsvirtuozzo.gif' , 'infodivid' => 'info7', 'bg-position' => '-1161', 'bg-image' => 'logo-control-panel'));
add_overlay_box(array('title' => 'SolusVM', 'info-url' => _('/control-panels/solusvm-license.php'), 'code' => 'LIN46', 'period' => _('Monthly'), 'logo' => 'logo-solusvm.gif' , 'infodivid' => 'info10', 'bg-position' => '-1300', 'bg-image' => 'logo-control-panel'));
