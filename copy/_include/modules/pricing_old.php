...
function get_plancode_from_enlish_url() {
	...
	switch ($uri) {
		...
		case '/additional-licenses/parallels-sitebuilder-license.php':
		case '/additional-licenses/parallels-sitebuilder-license.php?vps':
			$code = array('LIN76', 'LIN77');
			break;

		case '/additional-licenses/parallels-sitebuilder-license.php?dedicated':
			$code = 'LIN76';
			break;
