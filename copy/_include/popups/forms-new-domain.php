...
<div class="lc-popup">
	...
	<div class="lc-box-header">
		<div class="lc-float-left"><h2><?=_('New Requested Domain');?></h2></div>
	...
	<div class="lc-box">
		...
		<div id="form" class="lc-form">
				...
				<p><?=_('This is the domain name that is supposed to supersede the domain name that is defined in the "Current Domain" field.');?>    </p>
