...
<div class="lc-popup">
	...
	<div class="lc-box-header">
		<div class="lc-float-left"><h2><?=_('Server Password');?></h2></div>
	...
	<div class="lc-box" style="padding: 0px 18px 3px 18px;">
		...
		<div id="form" class="lc-form">
				...
				<p><?=_('This password is normally provided by your hosting provider, as in most cases this is the "root" password which is required to be able to login as secure shell (if you have a dedicated or vps services).');?>  </p>
