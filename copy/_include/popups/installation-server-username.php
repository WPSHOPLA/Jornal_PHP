...
<div class="lc-popup">
	...
	<div class="lc-box-header">
		<div class="lc-float-left"><h2><?=_('Server Username');?></h2></div>
	...
	<div class="lc-box" style="padding: 0px 18px 3px 18px;">
		...
		<div id="form" class="lc-form">
				...
				<p><?=_('For this field, we are requesting that you provide us with the "Root" login information so that we are able to access your server via secure shell access to start the installation of your software.');?> </p>
