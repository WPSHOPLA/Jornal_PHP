...
<div class="lc-header-inner"><div class="lc-header-inner-holder">
	<div class="header"><?php print ("$vps_cpanel_message"); ?></div>
</div></div>
	...
	<div class="lc-content-wrapper-inner">
		...
		<tr>
			...
			<td class="lc-content-right" valign="top">
                ...
                <div style="font-size: 16px; margin-top:-32px; fot-weight: bold; float: right; ">
				...
				<div class="lc-box">
					...
					<tr>
						...
						<td valign="top">
							<div id="screen1" class="lc-service-screen"><img src="<?=$img_dir?>/screen.jpg" width="320" height="223" alt="<?=_('cPanel License Screenshot');?>" /></div>
