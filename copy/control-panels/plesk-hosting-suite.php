...
<head>
	<title><?=$controlp_hostingsuite_title?></title>
	<meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
	<meta name="keywords" content="<?=$controlp_hostingsuite_keywords?>" />
	<meta name="description" content="<?=$controlp_hostingsuite_meta_description?>" />
...
<?php if (!empty($global_plan->lc_license_comment_message)): ?>
				...
				<?php endif; ?>
				<h1>Hosting Suite <?php print("$vps_plesk_version"); ?></h1>
