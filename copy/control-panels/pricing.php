...
function price_cloudlinux_dedicated_monthly() { return _get_price_from_code('LIN53'); }
...
function set_global_plan_from_url() { // TODO FIXME too fragile logic.  handle '?' query string for instance.
  ...
  $uri = $_SERVER['SCRIPT_NAME'];
	...
	switch ($uri) {
		...
		case _('/control-panels/plesk-hosting-suite.php?vps'):
			$code = 'LIN80';
			break;
			
		case _('/control-panels/plesk-hosting-suite.php'):
			$code = 'LIN80';
			break;
		
		case _('/control-panels/plesk-hosting-suite.php?dedicated'):
			$code = 'LIN81';
			break;
