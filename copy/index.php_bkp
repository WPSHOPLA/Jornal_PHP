...
<body>
  ...
  <div class="lc-header" style="background-image: url('<?php echo $img_dir?>/header/bg-tabs1.gif'); background-position:center bottom">
      ...
      <div >
          ...
          <div style="margin:0 auto; width:964px; background:none ">
          ...
          <ul id="lc-slideshownav" >              
              ...
              <li style="width:100%; background-image: url('<?php echo $img_dir?>/header/bg-tabs1.gif'); background-position:center bottom; height: 50px;   <?php if(getActualPage()=='es') echo "width: 242px;"; else echo "width: 244px;"; ?>">&nbsp;    
          ...
          <table width="100%" cellpadding="0" cellspacing="0">
			 ...
			 // printf(_('Select your %s Control Panel %s License Today!'), '<br />', '<br />');?></h1></div>
              ...
              <td class="lc-slide-right"><div class="lc-slide-tag" style="padding-top:92px">
                  ...
                  <h2 style="padding-bottom:8px"><?= _('per month!');?></h2>
  ...
  <div class="lc-content">
      ...
      <div class="lc-content-wrapper" style="padding-bottom:295px;">
          ...
          <tr>
                ...
                <td valign="top" style="width:625px"><table width="100%" cellpadding="0" cellspacing="0">
            ...
            <div class="lc-logos"><img src="<?=$img_dir?>/logos.gif" width="915" height="92" alt="<?= _('LicenseCube logo')?>" /></div>
