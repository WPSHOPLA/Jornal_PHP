...
<div class="loading">
    ...
    <img src="<?php echo $img_dir; ?>/misc/loading-grey-big.gif" alt="" />
    </div>
</div>
        ...
        <div class="container-body clearfix">
                ...
                <div class="grid_12">
                    <div class="containerPlus { width:'100%', buttons:'m', skin:'lc' }" style="position:relative;">
                      <div class="no">
                        <div class="ne"><div class="n">Current Licenses</div></div>
                        <div class="o"><div class="e"><div class="c">
                          <div class="mbcontainercontent">
                                ...
                                <div class="actions clearfix">
                                    <a href="#" class="ml15 fr btn btn-action"><span>Order New License</span></a>
